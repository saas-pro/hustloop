...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="h-auto flex justify-center relative p-2 py-10 md:py-20"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-[1100px] -mt-12 mx-auto aspect-video w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl flex"

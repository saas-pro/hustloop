              ...
              <TabsContent value="summary">
                <div className="space-y-8">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center gap-3">
                    ...
                    <div className='md:mr-8 flex justify-center w-full md:w-auto self-center'>
                      <TimelineCounter
                        ...
                        <CardContent className="pt-0">
                          <div className="flex items-center gap-3">
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="h-9 w-9 rounded-full bg-gradient-to-br from-purple-500 via-pink-500 to-orange-500 flex items-center justify-center hover:scale-110 transition-transform duration-300"
                            >
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="h-9 w-9 rounded-full bg-[#0077B5] flex items-center justify-center hover:scale-110 transition-transform duration-300"
                            >
                            ...
                            <a
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="h-9 w-9 rounded-full bg-black dark:bg-white flex items-center justify-center hover:scale-110 transition-transform duration-300"
                            >

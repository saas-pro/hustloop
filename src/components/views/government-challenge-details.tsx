...
import type { Governmentchallenges } from './msmes';
...
interface GovernmentChallengeDetailsProps {
  collaboration: Governmentchallenges | null;
...
export default function GovernmentChallengeDetails({
  ...
  isLoggedIn,
  hasSubscription
}: GovernmentChallengeDetailsProps) {
        ...
        <DialogHeader className="p-6">
          <div className="flex items-center gap-4">
            <Image
              ...
              alt={`${collaboration.challenge_type} logo`}
              width={80}
              height={80}
              className="rounded-lg"
              data-ai-hint={collaboration.company_name}
            />
            <div>
              ...
              <DialogDescription>
                A challenge by {collaboration.company_name}.
              </DialogDescription>
            </div>
          </div>
        </DialogHeader>
